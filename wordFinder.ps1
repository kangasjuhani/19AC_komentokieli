        ...
        if ($folderToSaveTo -eq [System.Windows.Forms.DialogResult]::OK)
            {
               ...
               if(Test-Path $pathOfNewFile -PathType Any){
                    ...
                    [microsoft.visualbasic.interaction]::MsgBox(“Saving was succesfull”)
               }else{
                    [void] [System.Reflection.Assembly]::LoadWithPartialName("Microsoft.VisualBasic") 
                    [Microsoft.VisualBasic.Interaction]::MsgBox("Something went wrong", "OKOnly,SystemModal,Exclamation", "Lockout?")
               }
            }
